// Jenkinsfile
//
// clickkart-auth-service's own copy of Jenkinsfile.template (Section 5: "no shared Jenkins
// library - copy this file into each service's own repo root"). Only SERVICE_NAME/SERVICE_PORT
...
pipeline {
    ...
    environment {
        SERVICE_NAME   = 'clickkart-auth-service'
        SERVICE_PORT   = '8081'
