// src/main/java/com/clickkart/auth/dto/ErrorDetail.java
 ...
 * can {@code switch} on (e.g. {@code "ACCOUNT_LOCKED"}) - never the free-text {@code message}
 ...
 * when a specific error carries extra structured detail (e.g. {@code lockedUntil}). Both are
